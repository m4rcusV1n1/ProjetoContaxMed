<%@ Page Title="" Language="C#" MasterPageFile="~/Administrador/administrador.Master" AutoEventWireup="true" CodeBehind="Default.aspx.cs" Inherits="RhAtestadook.Administrador.Default" %>
...
<p style="margin-left:15px;">Atestados Lançados:</p>
    <div id="gridview">
        <asp:GridView ID="Consulta_adm" runat="server" AutoGenerateColumns="false" AllowPaging="True" PageSize="35" ShowFooter="True"  onpageindexchanging="GridView1_PageIndexChanging" Width="813px" >
        <Columns>
        ...
        <ItemTemplate>
        <center><a href="javascript:abrir('página.aspx?id=<%#Eval("id")%>'); "><img src="../imagens/excluir.png" width="20" height="20" alt="excluir"></a></center>
        </ItemTemplate>
        </asp:TemplateField>
        </Columns>
    </asp:GridView>
