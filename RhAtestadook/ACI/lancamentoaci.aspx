<%@ Page Title="" Language="C#" MasterPageFile="~/ACI/aci.Master" AutoEventWireup="true" CodeBehind="lancamentoaci.aspx.cs" Inherits="RhAtestadook.ACI.lancamentoaci" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="FeaturedContent" runat="server">
    ...
    <script type="text/javascript">
        ...
        function completar_campos_re() {
            ...
            con_consulta.open("GET", "../Administrador/MostrarRe.aspx?re=" + re, true);
            con_consulta.send(null);
 ...
 <hr style="margin-top:10px; height: 3px; color:#24487C; background-color: #24487C;"/>
    ...
    &nbsp;&nbsp;<asp:TextBox ID="txtRe" runat="server" onblur="completar_campos_re()"></asp:TextBox>
     <img src="../Imagens/Loading_icon.gif" width="88" id="loading" alt="carregando" 
        style="display:none"/>
     <asp:RequiredFieldValidator ID="RequiredFieldValidator5" runat="server" ControlToValidate="txtRe" ErrorMessage="Campo Obrigatório" ForeColor="Red"></asp:RequiredFieldValidator>
    <br />
    <br />
    ...
    <br />
     &nbsp;&nbsp;<asp:TextBox ID="txtMedico" runat="server" Width="500px"/>
    ...
    &nbsp;&nbsp;<asp:TextBox ID="txtDescricao" runat="server" Width="500px" ReadOnly="true"/>
        <asp:RequiredFieldValidator ID="RequiredFieldValidator4" runat="server" ControlToValidate="txtDescricao" ErrorMessage="Campo Obrigatório" ForeColor="Red"></asp:RequiredFieldValidator>
    </div>
    <br />
